...
◊ol{
    ◊li{Digital fiat gets a poor score on ◊strong{acceptable} because it requires a bank account to use. This ◊link[for_the_unbanked]{isn't something everyone can get} as banks have the right to ◊link[undesirable_businesses]{reject you if they want}.◊sn{acceptable}
    }
...
◊ul{
    ...
    ◊li{Gold has stood the test of time. It's been used as money for thousands of years, while cryptocurrencies are just more than a decade old.◊mn{age-of-fiat}}
}
...
◊ol{
    ...
    ◊li{◊strong{The network effect}
        ...
        Money is better the more people who accept it. Getting people to start accepting a new form of money is difficult---even if it's better than the alternatives.◊mn{shock-of-the-old}
    }
}
...
Several countries---◊link[skatt-bitcoin]{like Sweden}---have ruled that Bitcoin isn't a currency. The reason is there's no responsible issuer and it's not ◊def{legal tender}◊mn{legal-tender} in any country.
