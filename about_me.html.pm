...
I'm still at the point where I'm not actively involved in cryptocurrencies. I hang out on Reddit, follow the development, and own a little but I'm not writing code or working on a project. While I work as a software developer, I don't have a cryptocurrency project I burn for enough to work on it in my free time. Unfortunately ever since I started programming full-time, it's been difficult to find energy for side-projects, like I had during my University years.
