...
I wonder what you might think of someone who's writing a book about cryptocurrencies? Maybe you'll think of a teenage multi-millionaire or an old neckbeard raving about free software? Or perhaps an anarchist who's trying to convince you that "governments are evil" and "taxation is theft"?◊sn{there-are}
...
It wasn't until four or maybe five years later I looked at Bitcoin again. I studied computer science and we had a course in cryptography---a very fun course I might add---with a section about cryptocurrencies. We went through the technical details and it made me curious about Bitcoin on a higher level. I read the white paper and began following the news and development in the space.
...
The free time I do have has been taken up by my two boys, my girlfriend and other hobbies. Saying no to something is saying yes to something else.◊sn{hobbies}
...
◊ndef["hobbies"]{
    ...
    I do have a very on-and-off relationship with my hobbies, which I pick up and do intensely for a short period of time. For instance I've been into ◊link[lockpicking]{lockpicking}, ◊link[go]{Go} and learning Korean, which I would like to start again some day.
