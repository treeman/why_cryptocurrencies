...
Sending money to other countries, called ◊em{remittance}, is one of the first promoted use-cases for cryptocurrencies. The benefits over existing solutions, such as Western Union, are numerous:◊mn{compare-to-banks}
...
There's an opportunity here for cryptocurrencies, which is demonstrated by the charity ◊link[eatbch]{eatBCH}, who use cryptocurrencies to help feed people in Venezuela. They receive donations in Bitcoin Cash from all over the world, which goes directly to volunteers inside the country, who use them to buy food and water from local vendors and give them to people in need.◊mn{venezuela-adoption}
...
◊div[#:class "inflation-examples"]{
    ...
    ◊inflation["Hungary"
               #:date "1945--1946"]{
        The worst hyperinflation in history ◊link[hungary-inflation]{happened in Hungary}, when they had to repay the cost of the second world war. There prices doubled in only 15 hours.◊mn{inflation-fascination}
...
Because of the decentralized nature of cryptocurrencies it's very difficult for them to "shut down". It doesn't matter if the computers of some people---or even whole countries---break down, the cryptocurrency network is unaffected.◊mn{antifragile}

Cryptocurrencies are so robust we might as well say they're always available, for anyone and anywhere (as long as they have internet access).◊mn{uptime}
