...
◊ndef["keys"]{
    Please make sure to encrypt your ◊em{seed} (a human-readable representation of your keys), otherwise a thief can easily steal your coins if he finds it.
}
...
I definitely don't know who's right. It's probably best to be skeptical of both camps---economics operate in an extremely complex and irregular environment. Economic theories are difficult, or impossible, to verify.
...
Commonly used payment systems, like credit cards for example, asks you to give up your privacy as all payments are recorded. So they require you to tie your identity to them. But cryptocurrencies can be used privately---there's no need to disclose your identity or your transaction history---making them similar to cash in this respect.◊mn{bitcoin-privacy}
...
Cryptocurrencies are inherently global. They're usable wherever you are as long as you have an internet connection. You can even send to wallets that are offline◊mn[#:top -8]{cold-storage}, but to retrieve them you need to access the internet. Technically, you could do transfers completely offline---on paper---but they would be unconfirmed and might not be valid when you do want to use them.
